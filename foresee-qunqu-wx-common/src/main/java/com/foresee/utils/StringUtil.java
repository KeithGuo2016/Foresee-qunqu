...
public class StringUtil {
	...
	static SimpleDateFormat df_sdf3=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
...
//		if(obj instanceof String) {}
	 ...
	 * @return
	 */
	public static List<String> getNotSameSection(List<String> list1,List<String> list2){
	 ...
	 */
	/*
	 * public static String initViewAuth(String userid_column, String
	 * departid_column) { StringBuffer sql = new StringBuffer();
	 * if(notBlank(userid_column)){ User user = HttpReqtRespContext.getUser();
	 * sql.append(" 1=1 and ( "+userid_column+" = '"+user.getId()+"' ");
	 * if(notBlank(departid_column)){
	 * sql.append(" or exists (select 1 from sen_user_department where userid='"
	 * +user.getId()+"' and departid="+departid_column+") "); } sql.append(" ) "); }
	 * return sql.toString(); }
	 */
	/**
	 * html代码编码
...
*  
	 ...
	 * //System.out.println(StringUtil.sNull("NAME "+QueryConditions.equal.trim()));
	 * }
	 */
}
