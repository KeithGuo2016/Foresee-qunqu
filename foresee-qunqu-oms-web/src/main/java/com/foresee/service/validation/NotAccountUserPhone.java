...
import com.foresee.service.validation.impl.AccountUserPhoneValidatorImpl;

import java.lang.annotation.*;
/*
 *Account UserPhone自定义校验 
 */
...
@Documented
@Constraint(validatedBy ={AccountUserPhoneValidatorImpl.class})  // 与约束注解关联的验证器
public @interface NotAccountUserPhone {

    String message() default "该手机号已存在";   // 约束注解验证时的输出消息
