...
@ApiModel(value="征稿表",description = "征稿表")
public class Contributes implements Serializable{
    ...
    @ApiModelProperty(value="征稿开始时间",name="startDate",example = "2019-07-27 13:30:20",required = true)
     ...
     */
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",locale = "zh",timezone = "GMT+8")
    @ApiModelProperty(value="征稿截止时间",name="endDate",example = "2019-08-01  13:30:20",required = true)
